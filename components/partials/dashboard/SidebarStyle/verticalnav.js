      ...
      <Accordion as="ul" className="navbar-nav iq-main-menu" id="sidebar-menu">
            ...
            <ul className="sub-nav">
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboards/profiles/profile1"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboards/profiles/profile2"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Profile 2</Tooltip>}
                  >
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboards/profiles/profile3"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboards/app/profile-images"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Profile Image</Tooltip>}
                  >
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboards/app/profile-videos"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboards/app/profile-events"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/app/profile-badges"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Profile Badges</Tooltip>}
                  >
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/app/profile-forum"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Profile Forum</Tooltip>}
                  >
          ...
          <Accordion.Collapse eventKey="friends-menu">
            <ul className="sub-nav">
              ...
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/friend-profile" ? "active" : ""
                  } nav-link`}
                  href="/friends/friend-profile"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <ul className="sub-nav">
              ...
              {/* <Nav.Item as="li">
                ...
                >
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Joined Groups</Tooltip>}
                  >
                    <i className="sidenav-mini-icon"> JG </i>
                  </OverlayTrigger>
        ...
        {/* <Nav.Item as="li">
          ...
          >
            <OverlayTrigger
              placement="right"
              overlay={<Tooltip>Donations</Tooltip>}
            >
              <i className="icon material-symbols-outlined">volunteer_activism</i>
            </OverlayTrigger>
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboards/market-place/market1"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboards/market-place/market2"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <ul className="sub-nav">
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/blog/blog-detail"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboards/store/store-category-grid"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboards/store/store-category-list"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboards/store/store-detail"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboards/store/store-checkout"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
            ...
            <ul className="sub-nav">
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/Email/email-compose"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/extrapages/pages-timeline"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/extrapages/pages-invoice"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/extrapages/pages-pricing"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/extrapages/pages-pricing-one"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/extrapages/pages-faq"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
            ...
            <ul className="sub-nav">
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/extra-pages/pages-maintenance"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
        ...
        <Nav.Item as="li">
          <Link
            ...
            href="/dashboard/extrapages/blankpage"
          >
            <OverlayTrigger
              placement="right"
        ...
        <Nav.Item as="li">
          <Link
            ...
            href="/extra-pages/pages-comingsoon"
          >
            <OverlayTrigger
              placement="right"
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-color"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-typography"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-alerts"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-badges"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-breadcrumb"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-buttons"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-cards"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-carousel"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-embed-video"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-images"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-list-groups"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-modal"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-notifications"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-pagination"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-popovers"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-progressbars"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/ui-kit/ui-tooltips"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/form/form-wizard"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/form/form-wizard-validate"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/form/form-wizard-vertical"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/table/tables-basic"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/table/data-table"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/table/table-editable"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/form/form-element"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/form/form-validation"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/form/form-switch"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/form/form-checkbox"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/form/form-radio"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/icon/fontawesome-5"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
              ...
              <Nav.Item as="li">
                <Link
                  ...
                  href="/dashboard/icon/lineawesome"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
